...
* [REST, REST API и RESTful API](#REST-API-и-RESTful-API)
* [Уровни изоляции транзакций на PostgreSQL](#Уровни-изоляции-транзакций)
...
Запросы REST API должны соответствовать принципам:
...
3. Запросы REST API не сохраняют статуса на сервере, могут проходить через слои серверов и кэшироваться.
